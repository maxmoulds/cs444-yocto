...
struct ncp_axis_mtc_MTC_DEBUG1_REG_ADDR_r_t {
	...
	unsigned curr_task_load_jtag_data_reg_continue_from_pause_dr_and_stop_in_pause_dr:1;
	...
	unsigned curr_task_load_jtag_inst_reg_continue_from_pause_ir_and_stop_in_pause_ir:1;
